...
CREATE TABLE `excep_log`  (
  ...
  `oper_uri` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '操作异常时的URI',
...
CREATE TABLE `login_log`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL,
  `user_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户登录时的ID',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `notify_config`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `system_message` smallint(0) NULL DEFAULT NULL COMMENT '系统消息配置：0：关闭，2：开启',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `udx_user_id`(`user_id`) USING BTREE COMMENT '用户ID唯一'
...
CREATE TABLE `operation_log`  (
  ...
  `oper_uri` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '操作URI',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `user_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '操作的用户ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `post`  (
  ...
  INDEX `idx_state`(`state`) USING BTREE COMMENT '状态索引'
...
CREATE TABLE `report`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL,
  `is_ill` smallint(0) NULL DEFAULT NULL COMMENT '是否违规',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `view_details`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL,
  `post_user_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '帖子拥有者的ID',
  `post_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '帖子处理后的内容',
  PRIMARY KEY (`id`) USING BTREE
